...
class RosenHost implements LMhost
// Demonstrates Rosenbrock's parabolic valley
// Triggers LM by instantiating an object of class LM
// Supplies five callback methods mandated by interface LMhost
{
    //--------constants---------------
    ...
    private double parms[] = {-1.2, +10.0};  // starting point

    public RosenHost() throws Exception
    {
    ...
    // This is Rosenbrock's banana.
    // Evaluates residual vector for parms[].
    // Returns sum-of-squares. 
    {
        double DIFFICULTY = 100.0; 
        resid[0] = DIFFICULTY * (parms[1] - parms[0]*parms[0]); 
        resid[1] = 1.0 - parms[0]; 
